...
size: 1248x832
quality: medium
generated: 2026-08-07T20:35:29
style_file: .claude/image-generation/style.md
outputs:
  - svc-training.png
---

Technical instructional drawing for a developer training service: a drafting table seen from above with a T-square, an open field notebook showing neat handwriting-like scribble lines (no legible text), and a mechanical pencil, arranged in an orderly grid layout. One dimension line with arrowheads measuring the notebook. Flat 2D patent-diagram linework, single orange accent on the pencil tip only.
