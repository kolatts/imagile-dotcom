...
size: 1248x832
quality: medium
generated: 2026-08-07T20:36:22
style_file: .claude/image-generation/style.md
outputs:
  - svc-workflows.png
---

Technical mechanism drawing for an automation-workflow service: a gear train of three meshed gears connected by a belt to a cam and follower, drawn as a flat 2D patent diagram with center-line crosses on each axle and one dimension line measuring the belt span. Precise thin technical-pen linework on faint drafting grid, single orange accent marking the follower's contact point.
