...
size: 1248x832
quality: medium
generated: 2026-08-07T20:37:03
style_file: .claude/image-generation/style.md
outputs:
  - svc-software.png
---

Exploded assembly drawing for a custom software service: a precision machine component (housing, internal gear, fasteners, cover plate) drawn in exploded view with thin dashed alignment lines connecting the parts vertically, small circled part-number balloons (empty circles, no text), flat 2D patent-diagram linework, one orange accent on the smallest fastener.
