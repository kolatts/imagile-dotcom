...
For heavyweight systems, that might be a RAG-based approach with vector databases — your knowledge lives in the database, and every agent query retrieves it from the same source. For lighter-weight systems, it might be something like the [Claude Code Marketplace](https://code.claude.com/docs/en/plugin-marketplaces), where shared plugins and instructions can be versioned and referenced rather than duplicated across contexts.
