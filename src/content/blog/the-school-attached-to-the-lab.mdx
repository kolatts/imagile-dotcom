...
If you came here from LinkedIn, the referral code is exactly what you'd guess: **LINKED-IN**. Bring it to the enrollment form, pick a first name and a throwaway PIN, and you have a file. No email required, nothing to unsubscribe from — the institution does not write first.
